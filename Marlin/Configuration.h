...
#define STRING_CONFIG_H_AUTHOR "(KentHage, Anet ET4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Emils ET4"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // ET4 Autotune PID results from: M303 E0 S220 C10
    #define DEFAULT_Kp 28.34
    #define DEFAULT_Ki 2.49
    #define DEFAULT_Kd 80.48
    // Save values with: M301 P28.34 I2.49 D80.48
  #endif
#else
...
#define PIDTEMPBED
  ...
  // ET4 Autotune PID results from: M303 E-1 C10 S65
  #define DEFAULT_bedKp 68.70
  #define DEFAULT_bedKi 13.42
  #define DEFAULT_bedKd 234.48
  // Save values with: M304 P68.70 I13.42 D234.48
#else
